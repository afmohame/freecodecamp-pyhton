...
class TVSeries(Movie):
    ...
    def __init__(self, title, year, director, duration, seasons, total_episodes):
        super().__init__(title, year, director, duration)#adds attributes from parent class
...
class MediaCatalogue:
    ...
    def add(self, media_item):
        if not isinstance(media_item, Movie):#this checks if media_item it is not a instance of Movie class which raises an error
